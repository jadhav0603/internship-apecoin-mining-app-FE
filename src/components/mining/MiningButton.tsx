...
export default function MiningButton({ onPress }: MiningButtonProps) {
  ...
  const animatedEndIconStyle = useAnimatedStyle(() => {
    return {
      ...
      transform: [{ scale: 0.8 + 0.2 * iconSwitch.value }],
      // position: 'absolute',
    };
  });
  ...
  <View style={styles.centerWrap}>
    ...
    {/* White rotating icon */}
    <Animated.View style={[styles.absoluteCenter, animatedIconStyle]}>
      <FontAwesome5
    ...
    {/* Green icon (same position) */}
    <Animated.View style={[styles.absoluteCenter, animatedEndIconStyle]}>
      <FontAwesome5
        name="hourglass-end"
        size={18}
      ...
      />
                    ...
                    <View style={styles.idleCueWrap}>
                      <Animated.View style={[styles.idleHalo, idleHaloStyle]} />
                      <Animated.View
                      ...
                      <Animated.Text
                        style={[styles.idleTapHint, idleHintStyle]}
                      >
                        TAP
                      </Animated.Text>
                    </View>
